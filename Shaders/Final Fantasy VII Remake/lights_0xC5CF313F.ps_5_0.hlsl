...
void main(float4 v0: TEXCOORD0, float4 v1: TEXCOORD3, float4 v2: TEXCOORD5, float4 v3: TEXCOORD6, float4 v4: TEXCOORD7,
          float4 v5: VertexContextVector0, float4 v6: SV_Position0, uint v7: SV_IsFrontFace0, out float4 o0: SV_Target0,
          ...
          out float4 o5: SV_Target5)
{
   ...
   r1.w = min(1, r1.w);
   r1.w = sqrt(r1.w);
   r7.xyz = v4.xyz * float3(0.5, 0.5, 0.5) + float3(0.5, 0.5, 0.5);
   r3.w = 1 + -r5.x;
   ...
   // FIX: Firefly Mitigation for Specular - ONLY FOR DLSS (SRType == 0)
