          ...
          out float4 o5: SV_Target5)
{
   ...
   r4.xyz = t3.Sample(s2_s, v0.xy).xyz;
   r5.xyz = cb3[2].www * cb3[2].xyz;
   r4.xyz = r5.xyz * r4.xyz;
   r5.xyz = t4.Sample(s3_s, v0.xy).xyz;
   r4.xyz = r4.xyz * r5.zzz + cb3[1].xyz;
   r6.xyz = t5.Sample(s4_s, v0.xy).xyz;
   r1.w = t6.Sample(s5_s, v0.zw).x;
