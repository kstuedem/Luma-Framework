  ...
  out float4 o0 : SV_Target0)
{
  ...
  r5.xyzw = t3.Sample(s3_s, v0.xy).xyzw;
  r4.xyz = r5.xyz + -r0.yzw;
  r5.x = cb0[26].y * r5.w;
  r0.yzw = r5.xxx * r4.xyz + r0.yzw;
  r4.x = r4.w * cb0[26].x + r5.x;
  ...
  r4.yzw = r4.yyy + -r0.yzw;
  r6.x = r5.w * r0.x;
  r6.y = r0.x * r5.w + -0.5;
  r6.xy = saturate(r6.xy + r6.xy);
  r2.xyzw = r6.xxxx * r2.xyzw + r3.xyzw;
  r1.xyzw = -r2.xyzw + r1.xyzw;
  r1.xyzw = r6.yyyy * r1.xyzw + r2.xyzw;
  r2.xyz = r1.www * r4.yzw + r0.yzw;
  r3.xyz = r2.xyz * r1.xyz;
  r1.xyz = -r1.xyz * r2.xyz + cb0[9].xyz;
  r1.xyz = cb0[9].www * r1.xyz + r3.xyz;
  r0.x = 1 + -r4.x;
  r2.x = cmp(r4.x < 0.00499999989);
  r0.x = 0.75 * r0.x;
  r2.yzw = float3(1,0.0500000007,0.0500000007) + -r0.yzw;
  r3.xyz = r0.xxx * r2.yzw + r0.yzw;
  r2.yzw = float3(0.0500000007,0.0500000007,1) + -r0.yzw;
  r5.xyz = r2.yzw * float3(0.800000012,0.800000012,0.800000012) + r0.yzw;
  r3.w = r5.w;
  r0.xyzw = r2.xxxx ? r5.xyzw : r3.xyzw;
  r1.w = r3.w;
