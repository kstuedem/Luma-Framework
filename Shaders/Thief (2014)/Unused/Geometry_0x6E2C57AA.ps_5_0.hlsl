  ...
  out float4 o3 : SV_Target3)
{
  ...
  r0.w = min(1, r0.w);
  r0.w = r1.y * r0.w;
  r1.xyz = r0.www * cb0[11].xyz + cb0[61].xyz;
  ...
  r5.xyz = cb0[62].xyz * r5.xyz;
  r6.xyz = cb0[63].xyz * r6.xyz;
  r0.w = dot(r6.xyz, r2.xyz);
  r1.xyz = r5.xyz * r0.www + r1.xyz;
  r2.xy = r3.xy * cb2[0].xy + cb2[0].wz;
  r2.xy = t4.Sample(s5_s, r2.xy).xy;
  r2.xy = cb0[59].xy * r2.xy + cb0[58].xy;
  ...
  r4.xyz = -r4.xyz * cb0[52].www + cb0[52].xyz;
  r0.w = dot(r4.xyz, r4.xyz);
  r0.w = rsqrt(r0.w);
  r6.xyz = r4.xyz * r0.www;
  r3.y = dot(r6.xyz, r4.xyz);
  r5.y = saturate(dot(r0.xyz, r6.xyz));
  r0.xy = saturate(r3.xy * cb0[56].xy + cb0[57].xy);
  r0.xy = -r0.xy * r0.xy + float2(1,1);
  r0.xy = log2(r0.xy);
  r0.xy = cb0[55].xy * r0.xy;
  r0.xy = exp2(r0.xy);
  r0.xy = r0.xy * r2.xy;
  r0.xy = r5.xy * r0.xy;
  r2.xyzw = cb0[54].xyzw * r0.yyyy;
  r0.xyzw = cb0[53].xyzw * r0.xxxx + r2.xyzw;
  r1.w = 0;
