  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.y = saturate(r4.w + r4.w);
  r0.y = 1 + -r0.y;
  r0.z = cb0[26].x * r0.y;
  r4.xyz = r0.zzz * -r4.xyz + r4.xyz;
  r5.xyzw = t2.Sample(s2_s, v0.xy).xyzw;
  r5.xyz = r5.xyz + -r4.xyz;
  r0.z = cb0[26].y * r5.w;
  r4.xyz = r0.zzz * r5.xyz + r4.xyz;
  r0.y = r0.y * cb0[26].x + r0.z;
  r0.z = GetLuminance(r4.xyz); // Luma: fixed from BT.601 coeffs
  ...
  r0.xzw = r1.www * r6.xyz + r4.xyz;
  r2.xyz = r1.xyz * r0.xzw;
  r0.xzw = -r1.xyz * r0.xzw + cb0[9].xyz;
  r1.xyz = cb0[9].www * r0.xzw + r2.xyz;
  r0.x = 1 + -r0.y;
  r0.y = cmp(r0.y < 0.00499999989);
  r0.x = 0.75 * r0.x;
  r2.xyz = float3(1,0.0500000007,0.0500000007) + -r4.xyz;
  r2.xyz = r0.xxx * r2.xyz + r4.xyz;
  r0.xzw = float3(0.0500000007,0.0500000007,1) + -r4.xyz;
  r5.xyz = r0.xzw * float3(0.800000012,0.800000012,0.800000012) + r4.xyz;
  r2.w = r5.w;
  r0.xyzw = r0.yyyy ? r5.xyzw : r2.xyzw;
  r1.w = r2.w;
