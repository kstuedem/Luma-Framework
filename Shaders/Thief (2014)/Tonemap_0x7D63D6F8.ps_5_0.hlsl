  ...
  out float4 o0 : SV_Target0)
{
  ...
  r6.x = r5.w * r0.y;
  r6.y = r0.y * r5.w + -0.5;
  r0.yz = saturate(r6.xy + r6.xy);
  r3.xyzw = r0.yyyy * r3.xyzw + r4.xyzw;
  r4.xyzw = cb0[6].xyzw + -cb0[5].xyzw;
  r4.xyzw = r0.xxxx * r4.xyzw + cb0[5].xyzw;
  r4.xyzw = r4.xyzw + -r3.xyzw;
  r0.xyzw = r0.zzzz * r4.xyzw + r3.xyzw;
  r2.xyz = r0.www * r2.xyz + r1.xyz;
  r3.xyz = r2.xyz * r0.xyz;
  r0.xyz = -r0.xyz * r2.xyz + cb0[9].xyz;
  r0.xyz = cb0[9].www * r0.xyz + r3.xyz;
  r2.xyz = float3(1,0.0500000007,0.0500000007) + -r1.xyz;
  r2.xyz = r2.www * r2.xyz + r1.xyz;
  r3.xyz = float3(0.0500000007,0.0500000007,1) + -r1.xyz;
  r5.xyz = r3.xyz * float3(0.800000012,0.800000012,0.800000012) + r1.xyz;
  r2.w = r5.w;
  r1.xyzw = r1.wwww ? r5.xyzw : r2.xyzw;
  r0.w = r2.w;
