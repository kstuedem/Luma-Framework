  ...
  out float4 o7 : TEXCOORD6)
{
...
#endif
  r0.xy = g_vUVOffsetSampling[6].xy * aspectRatioScale.xy + v1.xy;
  ...
  o3.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwwz;
  r0.xyzw = g_vUVOffsetSampling[2].xyzw * aspectRatioScale.xyxy + v1.xyxy;
  o4.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwzw;
  r0.xyzw = g_vUVOffsetSampling[3].xyzw * aspectRatioScale.xyxy + v1.xyxy;
  o5.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwzw;
  r0.xyzw = g_vUVOffsetSampling[4].xyzw * aspectRatioScale.xyxy + v1.xyxy;
  o6.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwzw;
  r0.xyzw = g_vUVOffsetSampling[5].xyzw * aspectRatioScale.xyxy + v1.xyxy;
  o7.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwzw;
}