...
SamplerState smplAnamorphicBloomIterate_s : register(s0);
Texture2D<float4> smplAnamorphicBloomIterate_Tex : register(t0);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    if (r1i.x >= 3) break;
    r1i.y = r1i.x << 1;
    r2.xyzw = smplAnamorphicBloomIterate_Tex.Sample(smplAnamorphicBloomIterate_s, v[r1i.x].xy).xyzw;
    ...
    r1i.y = mad(r1i.x, 2, 1);
    r3.xyzw = smplAnamorphicBloomIterate_Tex.Sample(smplAnamorphicBloomIterate_s, v[r1i.x].zw).xyzw;
    r3.xyzw = r3.xyzw * r1.wwww;
    r0.xyzw = icb[r1i.y+0].xxxx * r3.xyzw + r2.xyzw;
    r1i.x++;
  }
  r1.xyzw = smplAnamorphicBloomIterate_Tex.Sample(smplAnamorphicBloomIterate_s, v1.xy).xyzw;
