...
SamplerState smplLightShaftLinWork2_s : register(s0);
Texture2D<float4> smplLightShaftLinWork2_Tex : register(t0);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  while (true) {
    ...
    r2.xyzw = smplLightShaftLinWork2_Tex.Sample(smplLightShaftLinWork2_s, r2.xy).xyzw;
    r2.xyzw = vLightShaftBlurWeights[r0i.z].xxxx * r2.xyzw + r1.xyzw;
    r3.xyz = float3(1,2,3) + r0.www;
    r4.xyzw = r0.xyxy * r3.xxyy + v1.xyxy;
    r5.xyzw = smplLightShaftLinWork2_Tex.Sample(smplLightShaftLinWork2_s, r4.xy).xyzw;
    r2.xyzw = vLightShaftBlurWeights[r0i.z].yyyy * r5.xyzw + r2.xyzw;
    r4.xyzw = smplLightShaftLinWork2_Tex.Sample(smplLightShaftLinWork2_s, r4.zw).xyzw;
    r2.xyzw = vLightShaftBlurWeights[r0i.z].zzzz * r4.xyzw + r2.xyzw;
    r3.xy = r0.xy * r3.zz + v1.xy;
    r3.xyzw = smplLightShaftLinWork2_Tex.Sample(smplLightShaftLinWork2_s, r3.xy).xyzw;
