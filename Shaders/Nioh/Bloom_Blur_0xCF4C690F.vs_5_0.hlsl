  ...
  out float4 o4 : TEXCOORD3)
{
  ...
  o0.zw = v0.zw;
#if 1 // Luma: differently from the other shaders, the params from this one are fixed and not adjust by aspect ratio, so in UW it stretches bloom horizontally!
  ...
  o1.xyzw = r0.xyzw * g_vTexParam.xyxy + g_vTexParam.zwzw; // These added offsets are probably to do split screen support
