...
cbuffer g_DX11AlphaTestPS_CB : register(b2)
{
  struct
  {
    float4 params;
...
{
  float4 r0,r1;
  r0.xyzw = layer0_sampler.Sample(layer0_sampler_ss_s, v2.xy).xyzw;
  r0.xyzw = g_MaterialPS.fs_layer0_diffuse.xyzw * r0.xyzw;
  r0.w = saturate(w2.x * r0.w);
  r1.x = g_DX11AlphaTestPS.params.y * r0.w + -g_DX11AlphaTestPS.params.x;
  o0.w = r0.w;
  r0.w = cmp(r1.x < 0);
  if (r0.w != 0) discard;
  r1.xyzw = layer1_sampler.Sample(layer1_sampler_ss_s, v2.xy).xyzw;
  r1.xyzw = g_MaterialPS.fs_layer1_diffuse.xyzw * r1.xyzw;
