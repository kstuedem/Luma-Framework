  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = dot(g_LightsPS.fs_lightDirection0.xyz, r1.xyz);
  r1.x = dot(g_LightsPS.fs_lightDirection1.xyz, r1.xyz);
  r1.x = max(0, r1.x);
  r0.w = max(0, r0.w);
  r1.yzw = g_LightsPS.fs_lightColor0.xyz * r0.www + v2.xyz;
  r1.xyz = g_LightsPS.fs_lightColor1.xyz * r1.xxx + r1.yzw;
  r2.xyzw = layer1_sampler.Sample(layer1_sampler_ss_s, v4.xy).xyzw;
  r2.xyzw = g_MaterialPS.fs_layer1_diffuse.xyzw * r2.xyzw;
  r2.xyz = r2.xyz * r2.www;
  r3.xyz = v5.xyz + v5.xyz;
  r2.xyz = r3.xyz * r2.xyz;
  r2.xyz = r2.xyz * r2.xyz;
  r4.xyzw = layer0_sampler.Sample(layer0_sampler_ss_s, v4.zw).xyzw;
  r4.xyzw = g_MaterialPS.fs_layer0_diffuse.xyzw * r4.xyzw;
