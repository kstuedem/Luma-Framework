...
SamplerState legoSplatGun_sampler_ss_s : register(s5);
TextureCube<float4> sceneEnvmap_samplerCube : register(t3);
Texture2D<float4> legoSplatGun_sampler : register(t5);
  ...
  out float4 o0 : SV_Target0)
{
  ...
  r1.w = saturate(dot(-r2.xyz, g_LightsPS.fs_lightDirection1.xyz));
  r1.w = log2(r1.w);
  r1.w = g_MaterialPS.fs_specular_params.x * r1.w;
  r1.w = exp2(r1.w);
  r1.w = g_MaterialPS.fs_specular_params.w * r1.w;
  r2.w = dot(g_LightsPS.fs_lightDirection1.xyz, r1.xyz);
  r1.x = dot(g_LightsPS.fs_lightDirection0.xyz, r1.xyz);
  r1.x = max(0, r1.x);
  r1.y = max(0, r2.w);
  r1.z = r1.w * r1.y;
  r3.xyz = g_LightsPS.fs_lightColor1.xyz * r1.zzz;
  r1.z = saturate(dot(-r2.xyz, g_LightsPS.fs_lightDirection0.xyz));
  r1.z = log2(r1.z);
  r1.z = g_MaterialPS.fs_specular_params.x * r1.z;
  r1.z = exp2(r1.z);
  r1.z = g_MaterialPS.fs_specular_params.w * r1.z;
  r1.z = r1.z * r1.x;
  r4.xyz = g_LightsPS.fs_lightColor0.xyz * r1.xxx + v2.xyz;
  r1.xyw = g_LightsPS.fs_lightColor1.xyz * r1.yyy + r4.xyz;
  r3.xyz = g_LightsPS.fs_lightColor0.xyz * r1.zzz + r3.xyz;
  ...
  r1.z = g_MaterialPS.fs_brdf_params.x * r2.w + r1.z;
  r2.xyz = r2.xyz * r1.zzz;
  r2.xyz = r2.xyz * r2.xyz + r3.xyz;
  r1.z = r0.w * r0.w;
  r1.z = r1.z * r1.z;
  r0.w = r1.z * r0.w;
  r1.z = 1 + -g_MaterialPS.fs_fresnel_params.y;
  r0.w = r1.z * r0.w + g_MaterialPS.fs_fresnel_params.y;
  r1.z = 1 + -g_MaterialPS.fs_specular_params.z;
  r2.w = r1.z * r0.w;
  r0.w = -r0.w * r1.z + 1;
  r1.z = saturate(g_MaterialPS.fs_specular_specular.x * r2.w);
  r2.xyz = r1.zzz * r2.xyz;
  r1.z = 1 + -g_MaterialPS.fs_brdf_params.y;
  r0.w = r1.z * r0.w + g_MaterialPS.fs_brdf_params.y;
  r3.xyz = -v4.xyz * float3(2,2,2) + g_MiscGroupPS.fs_per_pixel_fade_col.xyz;
  r4.xyz = v4.xyz + v4.xyz;
  r3.xyz = g_MiscGroupPS.fs_per_pixel_fade_col.www * r3.xyz + r4.xyz;
  r1.z = g_MiscGroupPS.fs_per_pixel_fade_pos.w * g_MiscGroupPS.fs_per_pixel_fade_pos.w + g_MiscGroupPS.fs_per_pixel_fade_pos.w;
  r5.xyz = g_MiscGroupPS.fs_per_pixel_fade_pos.xyz + -v1.xyz;
