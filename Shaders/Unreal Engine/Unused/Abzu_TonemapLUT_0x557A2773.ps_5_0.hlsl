  ...
  out float4 o0 : SV_Target0)
{
  ...
  r0.w = 1.00055635 * cb0[36].x;
  r1.x = cmp(6996.10791 >= cb0[36].x);
  ...
  r2.xyz = cb0[36].xxx * float3(0.000154118257,0.00084242021,4.22806261e-005) + float3(0.860117733,1,0.317398727);
  r0.w = cb0[36].x * cb0[36].x;
  r2.xyz = r0.www * float3(1.28641219e-007,7.08145137e-007,4.20481676e-008) + r2.xyz;
  r2.x = r2.x / r2.y;
  r1.z = -cb0[36].x * 2.8974182e-005 + 1;
  ...
  r0.x = cmp(cb0[27].w == 0.000000);
  if (r0.x != 0) {
    r0.x = dot(r1.xyz, cb0[20].xyz);
    r0.y = dot(r1.xyz, cb0[21].xyz);
    r0.z = dot(r1.xyz, cb0[22].xyz);
    r0.w = dot(r1.xyz, cb0[25].xyz);
    r0.w = 1 + r0.w;
    r0.w = rcp(r0.w);
    ...
    r4.xyz = r3.xyz * cb0[24].xxx + cb0[24].yyy;
    r3.xyz = cb0[23].www + r3.xyz;
    r3.xyz = rcp(r3.xyz);
    r5.xyz = cb0[20].www * r2.xyz;
    r2.xyz = cb0[23].yyy + r2.xyz;
    r2.xyz = rcp(r2.xyz);
    r2.xyz = r5.xyz * r2.xyz + cb0[21].www;
    r0.xyz = r0.xyz * cb0[22].www + r2.xyz;
    ...
    r1.y = max(r2.y, r0.w);
    r1.y = max(r1.y, r2.z);
    r1.xyz = max(float3(1.00000001e-010,1.00000001e-010,0.00999999978), r1.xyy);
    r1.x = r1.y + -r1.x;
    r1.x = r1.x / r1.z;
    r1.y = cmp(r0.w == r2.y);
    r1.z = cmp(r2.z == r2.y);
    r1.y = r1.z ? r1.y : 0; // TODO: there's a couple of "and" instructions here, are the valid?
    r1.z = r2.y + -r2.z;
    ...
    r2.xy = float2(1,0.180000007) + cb0[28].ww;
    r0.w = -cb0[28].y + r2.x;
    r1.w = 1 + cb0[29].x;
    r2.x = -cb0[28].z + r1.w;
    r2.z = cmp(0.800000012 < cb0[28].y);
    r3.xy = float2(0.819999993,1) + -cb0[28].yy;
    r3.xy = r3.xy / cb0[28].xx;
